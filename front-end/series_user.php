...
<body class = background>
    ...
    <div class="search-container">
        <form method="post" action="/softeng23-16/front-end/series_user.php">
    ...
    <div class="movies-container">
        <?php foreach ($series as $episode): ?>
            <div class="movie">
                <a href="/softeng23-16/front-end/series_details_user.php?id=<?= htmlspecialchars($episode['T_const']); ?>">
