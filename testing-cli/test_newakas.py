...
class TestUploadTitleAkas:
    ...
    def test_upload_titleakas_endpoint(self, file_content, expected_status, expected_message):
        endpoint = f"{BASE_URL}admin/upload/titleakas"
...
if __name__ == "__main__":
    commands = [
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.akas.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.akas.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.akas.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/README.md" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.aks.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.akas.tsv" --format csv --host "non-localhost"',
        'python ../../softeng23-16/cli-client/src/se2316.py newakas --filename "../../softeng23-16/api/truncated_title.akas.tsv" --format csv --user "incorrect_user" --password "incorrect_password"'
    ]
