...
class TestUploadTitleCrew:
    ...
    def test_upload_titlecrew_endpoint(self, file_content, expected_status, expected_message):
        endpoint = f"{BASE_URL}admin/upload/titlecrew"
...
if __name__ == "__main__":
    commands = [
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/README.md" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv" --format csv --host "non-localhost"',
        'python ../../softeng23-16/cli-client/src/se2316.py newcrew --filename "../../softeng23-16/api/truncated_title.crew.tsv" --format csv --user "incorrect_user" --password "incorrect_password"'
    ]
