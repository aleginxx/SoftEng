...
class TestUploadTitleEpisode:
    ...
    def test_upload_titleratings_endpoint(self, file_content, expected_status, expected_message):
        endpoint = f"{BASE_URL}admin/upload/titleratings"
...
if __name__ == "__main__":
    commands = [
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv"',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/README.md" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv" --format csv',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv" --format csv --host "non-localhost"',
        'python ../../softeng23-16/cli-client/src/se2316.py newratings --filename "../../softeng23-16/api/truncated_title.ratings.tsv" --format csv --user "incorrect_user" --password "incorrect_password"'
    ]
