...
router.post('/admin/upload/titleprincipals', upload.single('file'), async (req, res) => {
    try {
        if (!req.file) {
        ...
        const tempFilePath = path.join(__dirname, '../uploads', 'temp_title_principals.tsv');
...
router.get('/admin/upload/titleprincipals', (req, res) => {
