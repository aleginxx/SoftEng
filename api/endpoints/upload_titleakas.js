...
router.post('/admin/upload/titleakas', upload.single('file'), async (req, res) => {
    try {
        if (!req.file) {
        ...
        const tempFilePath = path.join(__dirname, '../uploads', 'temp_title_akas.tsv');
...
router.get('/admin/upload/titleakas', (req, res) => {
